...
import styles from './biowc-scatter-ts.css';

export class BiowcScatterTs extends LitElement {
  ...
  private _plotScatter() {
    ...
    let x1 = minValueX;
    const x2 = maxValueX;
    const equation = BiowcScatterTs._linearRegression(YaxisData, XaxisData);
